...
// const ms = require("ms");
// import ms from "ms";
// console.log('test ms - will try parse a string "26h 32m"');
// const duration = ms("26h 32m"); // Parses and converts to milliseconds
// console.log("here is the result: ", duration);
// //console.log(duration); // Output: 95520000
// console.log('will try to parse with long: true value')
// console.log(ms(duration, { long: true })); // Output: 26 hours 32 minutes
// // console.log(ms(duration)); // 1582 (total minutes)
...
var filePath = "../data/flights2.csv";
